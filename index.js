...
async function banner() {
    ...
    const bannerText = `
\x1b[96m⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\x1b[0m     ${bold}${hijau}Welcome to PermenMD-X-Ricko Script${Reset}
\x1b[96m⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢸⡇⠀⠀⠀⠀⠀⠀⠀⠀⠀⢸⡇⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\x1b[0m          ${hijau}Full Power DDoS Tools${Reset}
\x1b[96m⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢸⣧⠀⠀⠀⠀⠀⠀⠀⠀⠀⣸⡇⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\x1b[0m______________________________________________
\x1b[96m⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢸⣿⠀⠀⠀⠀⠀⠀⠀⠀⠀⣿⡇⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\x1b[0m
\x1b[96m⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢸⣿⡄⠀⠀⠀⠀⠀⠀⠀⢀⣿⡇⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\x1b[0m     Telegram: ${biru}@RickoGTR${Reset}
\x1b[96m⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢰⡄⢸⣿⣇⠀⠀⠀⠀⠀⠀⠀⢸⣿⡇⢠⡆⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\x1b[0m     Channel: ${biru}t.me/RickoStresser${Reset}
\x1b[96m⢲⣤⡀⠀⠀⠀⠀⠀⠀⠀⣸⡇⢸⣿⣿⠀⠀⠀⠀⠀⠀⠀⣿⣿⡇⢸⣇⠀⠀⠀⠀⠀⠀⠀⢀⣠⡖\x1b[0m     Version: ${version}
\x1b[96m⠀⠹⣿⣆⠀⠀⠀⠀⠀⣰⣿⠇⢸⣿⣿⠀⠀⠀⠀⠀⠀⠀⣿⣿⡇⠸⣿⣆⠀⠀⠀⠀⠀⣰⣿⠏⠀\x1b[0m     VIP: Yes
\x1b[96m⠀⠀⢻⣿⡆⠀⠀⠐⢿⣿⣿⣦⣼⣿⣿⡇⠀⠀⠀⠀⠀⢰⣿⣿⣇⣴⣿⣿⡿⠂⠀⠀⢰⣿⡟⠀⠀\x1b[0m     Max time: 1000
  ...
  try {
    ...
    permen.question(`${back_putih}${teksmerah}Input Password${Reset}: `, async (skibidi) => {
      if (skibidi === password.trim()) {
        ...
        await sleep(700)
        console.clear()
        console.log(`Welcome To ${biru}Ricko${Reset} ${hijau}DDoS Tools!${Reset}${version}`)
        await sleep(1000)
		    await banner()
        console.log(`Type ${hijau}"menu"${Reset} For Showing All Available Command`)
        sigma()
      } else {
...
Type exit To Stop
`);
permen.question(`${back_putih}${teksmerah}Ricko DoS${Reset}➔ ${back_putih}${teksmerah}WiFi Killer${Reset}: \n`, async (yakin) => {
if (yakin === 'exit') {
...
permen.question(`${back_putih}${teksmerah}Ricko DoS${Reset}➔ ${back_putih}${teksmerah}Chat AI${Reset}: `, async (yakin) => {
if (yakin === 'exit') {
...
Created And Coded Full By Ricko and PermenMD
...
YouTube ( Music )
`
permen.question(`${back_putih}${teksmerah}RickoX-DDoS${Reset}➔ ${back_putih}${teksmerah}Console${Reset} ${back_putih}${teksmerah}►${Reset} `, (input) => {
...
${creatorCredits}`);
    ...
    console.log(`Ricko Ai Ragbot Started
